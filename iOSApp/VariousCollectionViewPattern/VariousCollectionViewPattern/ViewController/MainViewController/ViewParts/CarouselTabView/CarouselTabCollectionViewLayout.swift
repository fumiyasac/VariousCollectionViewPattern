//
//  CarouselTabCollectionViewLayout.swift
//  VariousCollectionViewPattern
//
//  Created by 酒井文也 on 2023/05/25.
//

import UIKit

final class CarouselTabCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    // UICollectionViewに配置しているセルの幅
    static let categoryCellWidth: CGFloat = 150.0

    // 該当のセルのオフセット値を計算するための値（スクリーンの幅 - UICollectionViewに配置しているセルの幅）
    private let horizontalTargetOffsetWidth: CGFloat = UIScreen.main.bounds.width - CarouselTabCollectionViewLayout.categoryCellWidth
